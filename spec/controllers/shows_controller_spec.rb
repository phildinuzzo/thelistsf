  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved show as @show" do
        ...
        post :create, {:show => { "date" => "invalid value" }}, valid_session
        assigns(:show).should be_a_new(Show)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested show" do
        ...
        Show.any_instance.should_receive(:update_attributes).with({ "date" => "MyString" })
        put :update, {:id => show.to_param, :show => { "date" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the show as @show" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Show.any_instance.stub(:save).and_return(false)
        put :update, {:id => show.to_param, :show => { "date" => "invalid value" }}, valid_session
        assigns(:show).should eq(show)
      end
